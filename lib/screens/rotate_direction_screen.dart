...
class RotateDirectionScreen extends StatefulWidget {
  final int currentDegrees;
  final Device device;

  const RotateDirectionScreen({
    super.key, 
  ...
  @override
  State<RotateDirectionScreen> createState() => _RotateDirectionScreenState();
}

class _RotateDirectionScreenState extends State<RotateDirectionScreen> {
  ...
  String _getCommandValue(String position) {
    ...
    switch(position) {
      case 'topRight':
        return isPositive ? '26' : '36';
      case 'topMiddle':
        return isPositive ? '21' : '31';
      case 'topLeft':
        return isPositive ? '25' : '35';
      case 'middleRight':
        return isPositive ? '24' : '34';
      case 'middleLeft':
        return isPositive ? '23' : '33';
      case 'bottomRight':
        return isPositive ? '27' : '37';
      case 'bottomMiddle':
        return isPositive ? '22' : '32';
      case 'bottomLeft':
        return isPositive ? '28' : '38';
      default:
        return '40';
    }
  }
